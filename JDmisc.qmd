...
bind_rows(
  rms.sum.table3(summary = summary(t3.mod, age = c(50, 70)), trib.cols.rms, raw = TRUE) ,
rms.sum.table3(summary = summary(t3.mod, age = c(50, 55)), trib.cols.rms, raw = TRUE) ) %>% 
  bind_rows(.,
            rms.sum.table3(summary = summary(t3.mod, age = c(50, 40)), trib.cols.rms, raw = TRUE)) %>% 
    bind_rows(.,
            rms.sum.table3(summary = summary(t3.mod, age = c(50, 25)), trib.cols.rms, raw = TRUE)) %>% 
      bind_rows(.,
            rms.sum.table3(summary = summary(t3.mod, age = c(50, 15)), trib.cols.rms, raw = TRUE)) %>% 
        bind_rows(.,
            rms.sum.table3(summary = summary(t3.mod, age = c(50, 5)), trib.cols.rms, raw = TRUE)) %>% 
